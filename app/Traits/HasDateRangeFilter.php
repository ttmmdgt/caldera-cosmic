...
trait HasDateRangeFilter
{
    ...
    {
        $this->start_at = Carbon::now()->startOfQuarter()->format('Y-m-d\TH:i');
        $this->end_at = Carbon::now()->endOfQuarter()->format('Y-m-d\TH:i');
        $this->dispatch('update');
    }

    public function setLastQuarter()
    {
        $this->start_at = Carbon::now()->subQuarter()->startOfQuarter()->format('Y-m-d\TH:i');
        $this->end_at = Carbon::now()->subQuarter()->endOfQuarter()->format('Y-m-d\TH:i');
        $this->dispatch('update');
    }
}
