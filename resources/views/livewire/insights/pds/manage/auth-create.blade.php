...
new class extends Component {
    ...
    {
        return [
            "user_id" => ["required", "gt:0", "integer", "unique:ins_ph_dosing_auths"],
            "actions" => ["array"],
            "actions.*" => ["string"],
        ];
    }
...
<div>
    <form wire:submit="save" class="p-6">
        ...
        <div class="grid grid-cols-1 gap-y-3 mt-6">
            <x-checkbox id="new-device-manage" wire:model="actions" value="device-manage">{{ __("Mengelola perangkat PDS") }}</x-checkbox>
        </div>
