...
new class extends Component {
    ...
    public function save()
    {
        ...
        $auth = InsPhDosingAuth::find($this->id);
        if ($auth) {
...
<div>
    <form wire:submit="save" class="p-6">
        ...
        <div class="grid grid-cols-1 gap-y-3 mt-6">
            <x-checkbox id="device-manage" :disabled="!$is_superuser" wire:model="actions" value="device-manage">{{ __("Mengelola perangkat PDS") }}</x-checkbox>
        </div>
        @can("superuser")
