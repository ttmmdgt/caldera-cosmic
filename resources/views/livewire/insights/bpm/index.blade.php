...
<x-slot name="title">{{ __("Pemantauan back part mold") }}</x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-neutral-900 dark:text-neutral-100">
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold">{{ __("Pemantauan back part mold") }}</h2>
                    <p class="text-neutral-600 dark:text-neutral-400 mt-2">
                        {{ __("Sistem monitoring Back Part Mold untuk proses assembly") }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-neutral-50 dark:bg-neutral-700 p-6 rounded-lg">
                        ...
                        <p class="text-neutral-600 dark:text-neutral-400 mb-4">
                            {{ __("Akses data real-time dan ringkasan historis dari semua line BPM") }}
                        </p>
                        <a href="{{ route('insights.bpm.data.index') }}" 
